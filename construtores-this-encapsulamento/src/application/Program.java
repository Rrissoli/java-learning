...
public class Program {
    public static void main(String[] args) {
        ...
        // regra de outo , o objeto deve sempre estar em um estado consistente , e a propria classe deve garantir isso

        // regra geral basica
        // um objeto nao deve expor nenhum atributo (modificador de acesso private)
        // os atributos devem ser acessador por meio de metodos get e set 
		...
		product1.totalValueUnStock();
		System.out.printf("Name: %s %n Price: %.2f %n Quantity: %d %n Total: %.2f %n", product1.getName(), product1.getPrice(),product1.getQuantity(), product1.totalValueUnStock());
		System.out.println("quanto deseja colocar em estoque");
        product1.addProducts(cs.nextInt());
		System.out.printf("Name: %s %n Price: %.2f %n Quantity: %d %n Total: %.2f %n", product1.getName(), product1.getPrice(),product1.getQuantity(), product1.totalValueUnStock());
